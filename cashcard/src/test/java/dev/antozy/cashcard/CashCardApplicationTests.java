...
class CashCardApplicationTests {
    ...
    void shouldReturnAllCashCardsWhenListIsRequested() {
        ...
        DocumentContext documentContext = JsonPath.parse(response.getBody());
        int cashCardCount = documentContext.read("$.length()"); // Lenght of the array
        assertThat(cashCardCount).isEqualTo(3);

        JSONArray ids = documentContext.read("$..id"); // All ids in array
        assertThat(ids).containsExactlyInAnyOrder(99, 100, 101);

        JSONArray amounts = documentContext.read("$..amount"); // sum amount in array
    ...
    void shouldNotUpdateACashCardThatDoesNotExist() {
        ...
        ResponseEntity<Void> response = restTemplate.withBasicAuth("sarah1", "abc123").exchange("/cashcards/999999", HttpMethod.PUT, request, Void.class);
    ...
    void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn() {
        ...
        ResponseEntity<String> getResponse = restTemplate.withBasicAuth("kumar2","xyz789").getForEntity("/cashcards/102", String.class);
